...
<a href="liste-voiture.php" style="text-decoration: none;">
	<div class="vignettePanneauAdministration">
		...
		<br>
		<img src="../mini/miature_gestion_voiture.png" alt="Gestion des Voitures" style="width:100%; height:70%;"></img>
	</div>
</a>

<div class="vignettePanneauAdministration" style="left:33%;">
	<div>
		<p class="texteVignettePanneauAdministration">
			<br>
...
<a href="visiteurs.php" style="text-decoration: none;">
	<div class="vignettePanneauAdministration" style="left:66%;">
		<br>
		<p class="texteVignettePanneauAdministration">
			Statistiques des Visiteurs
		</p>
		<iframe src="visiteurs.php" style="width:25%; height:12.1em; margin-left:4em;" name="iframeVisiteurs" onload="window.frames['iframeVisiteurs'].scrollTo(0,200)" scrolling="no" class="iframeVignettePanneauAdministration"></iframe>
	</div>
</a>

<a href="contenu.php" style="text-decoration: none;">
	<div class="vignettePanneauAdministration" style="top:50%;">
		<br>
		<p class="texteVignettePanneauAdministration">
...
<div class="vignettePanneauAdministration" style="left:33%; top:50%;">
	<br>
	<p class="texteVignettePanneauAdministration">
		<?php 
...
<a href="visiteurs.php" style="text-decoration: none; color:#d8d9da;">
	<div class="vignettePanneauAdministration" style="left:66%; top:50%;">
		<br>
		<p class="texteVignettePanneauAdministration">
			Statistiques des Visiteurs
		</p>
